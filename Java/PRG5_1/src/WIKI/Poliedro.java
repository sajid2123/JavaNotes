...
public class Poliedro {
	...
	public static void main(String[] args) {
		...
		case 2: 
			...
			break;
		case 3: 
			System.out.println("Dime Alumno entre 0 y 3");
			x = tec.nextInt();
			System.out.println("Dime Evaluacion entre 0 y 2");
			y = tec.nextInt();
			opcionTres(a,x,y);
			break;
		case 4: 
			System.out.println("Dime Evaluacion entre 0 y 2");
			x = tec.nextInt();
			System.out.println("Dime Asignatura entre 0 y 1");
			y = tec.nextInt();
			opcionCuatro(a,x,y);
			break;
		case 5: 
		...
		public static void opcionTres(int [][][]a, int x, int y) {
			int alumno = x;
			int evaluacion = y;
		...
		public static void opcionCuatro(int [][][]a, int x, int y) {
		...
		public static void opcionCinco(int [][][]a,int x,int y) {
			int asignatura = 1;
			int alumno = 1;
			System.out.println("Alumno: " + alumno);
			System.out.println("Asignatura: " + asignatura);
		...
		public static void getMenu() {
			...
			System.out.println("3. Para mostrar las notas de todas asignaturas del un alumno, en una evaluacion.");
			System.out.println("4. Para mostrar las notas de todos alumnos en una evaluacion , en una asignatura.");
			System.out.println("5. Para mostrar las notas de todas evaluaciones del un alumno, en una asignatura.");
